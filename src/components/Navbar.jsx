...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="relative flex justify-between items-center w-full h-16 px-5 py-3 text-black z-10" style={{ backgroundImage: "radial-gradient(circle, #4D869C 0%, #4D869C 100%)", backgroundColor: "#4D869C" }}>
